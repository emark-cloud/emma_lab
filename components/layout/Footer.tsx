...
const CONTACTS = [
  { icon: "fas fa-phone-alt", label: "+234 813 602 5120", href: "tel:+2348136025120" },
  { icon: "fab fa-whatsapp", label: "+234 912 091 4837", href: "https://wa.me/2349120914837", external: true },
  { icon: "fas fa-envelope", label: "emmalabglobal@gmail.com", href: "https://mail.google.com/mail/?view=cm&to=emmalabglobal@gmail.com", external: true },
];
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              {CONTACTS.map((c) => (
                ...
                >
                  <i className={`${c.icon} text-accent text-xs`} aria-hidden />
                  {c.label}
                </a>
              ))}
            </div>
